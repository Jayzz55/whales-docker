...
ENV INSTALL_PATH /whales
# The name of the application is whales and while there
...
# having to CD into the /whales folder every time would be
# lame, so instead we can set the WORKDIR to be /whales.
#
...
# whales/ path inside of the Docker image.
#
# It copies it to /whales because of the WORKDIR being set.
#
...
# /whales folder inside of the Docker image.
#
